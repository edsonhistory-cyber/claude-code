...
export const CASE_FILES = {
  ...
  CASE003: {
    FULL: 'CASE003_FULL',
    EVENTS: 'CASE003_EVENTS_FULL',
    EVIDENCES: 'CASE003_EVIDENCES_FULL',
    DOCUMENTS: 'CASE003_DOCUMENTS_FULL',
    DIALOGUES: 'CASE003_DIALOGUES_FULL',
    WORLD: 'CASE003_COMPLETE_WORLD_STATE',
    IMAGES: 'CASE003_IMAGES_FULL',
    PACK: 'CASE003_CONTENT_PACK',
  },
  CASE004: {
    FULL: 'CASE004_FULL',
    EVENTS: 'CASE004_EVENTS_FULL',
    EVIDENCES: 'CASE004_EVIDENCES_FULL',
    DOCUMENTS: 'CASE004_DOCUMENTS_FULL',
    DIALOGUES: 'CASE004_DIALOGUES_FULL',
    WORLD: 'CASE004_COMPLETE_WORLD_STATE',
    IMAGES: 'CASE004_IMAGES_FULL',
    PACK: 'CASE004_CONTENT_PACK',
  },
  CASE005: {
    FULL: 'CASE005_FULL',
    EVENTS: 'CASE005_EVENTS_FULL',
    EVIDENCES: 'CASE005_EVIDENCES_FULL',
    DOCUMENTS: 'CASE005_DOCUMENTS_FULL',
    DIALOGUES: 'CASE005_DIALOGUES_FULL',
...
export async function loadAll(caseId = 'CASE001', onProgress = () => {}) {
  ...
  if (!('PORTRAIT_PHOTOS' in store)) {
    store.PORTRAIT_PHOTOS = await fetch('assets/images/portraits/manifest.json')
      .then((r) => (r.ok ? r.json() : null))
      .catch(() => null);
  }
